...
- Touching anything under `lww-register/src/`? Re-read AGENTS.md §9.2 — every file in that crate is
  ...
  `rbsr` crates (`rsos/src/fingerprint_tree_map.rs`, `rsos/src/fingerprint_tree_map_iter.rs`, `rsos/src/encoding.rs`,
  `rsos/src/fingerprint.rs`, `rsos/src/aggregate.rs`, `rbsr/src/protocol.rs`, `rbsr/src/rsos_view.rs`)
