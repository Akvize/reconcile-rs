...
Measured, not only counted: `benches/README.md`'s `service_reconcile_rtt` lane
([#461](https://github.com/Akvize/reconcile-rs/issues/461)) drives this over an injected-RTT link
end to end and confirms the round-trip cost the paragraph above states — exceeding the counted
model below n = 10⁶, and no longer a fixed function of `n` at all by n = 10⁶.
